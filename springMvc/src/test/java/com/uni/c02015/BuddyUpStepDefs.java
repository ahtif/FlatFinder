...
//	
	  ...
	  public void i_search_for_a_buddy_on_the_page(String arg1) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }
	  ...
	  public void i_should_be_redirected_to(String arg1) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }

	  @Given("^a searcher \"([^\"]*)\" with password \"([^\"]*)\"$")
	  public void a_searcher_with_password(String arg1, String arg2) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }

	  @Given("^a searcher \"([^\"]*)\" who hasnt opted in to the buddyup system$")
	  public void a_searcher_who_hasnt_opted_in_to_the_buddyup_system(String arg1) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }
	  ...
	  public void i_search_for_a_buddy(String arg1) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }

	  @When("^I access the \"([^\"]*)\" to find \"([^\"]*)\"$")
	  public void i_access_the_to_find(String arg1, String arg2) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }

	  @Then("^I should navigate to \"([^\"]*)\"$")
	  public void i_should_navigate_to(String arg1) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }

	  @Then("^I should be able to send a buddy up request$")
	  public void i_should_be_able_to_send_a_buddy_up_request() throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }

	  @When("^I send \"([^\"]*)\" a \"([^\"]*)\"$")
	  public void i_send_a(String arg1, String arg2) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }

	  @Then("^a buddy request \"([^\"]*)\" will be added to the list of buddy request for \"([^\"]*)\"$")
	  public void a_buddy_request_will_be_added_to_the_list_of_buddy_request_for(String arg1, String arg2) throws Throwable {
	      // Write code here that turns the phrase above into concrete actions
	      throw new PendingException();
	  }
